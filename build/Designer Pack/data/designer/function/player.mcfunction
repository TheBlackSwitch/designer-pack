execute if score @s d.state matches -1 run function designer:player/nested_execute_0
execute if score @s d.state matches 1 unless dimension designer:plot_1 unless dimension designer:plot_2 unless dimension designer:plot_3 unless dimension designer:plot_3 unless dimension designer:plot_4 unless dimension designer:plot_5 run function designer:player/nested_execute_1
